...
class EditProductByField extends StatefulWidget {
  final ProductByField product;

  EditProductByField([this.product]);

  @override
  _EditProductByFieldState createState() => _EditProductByFieldState();
}

class _EditProductByFieldState extends State<EditProductByField> {
    ...
    if (widget.product == null) {
      ...
      new Future.delayed(Duration.zero, () {
        final productProvider =
            Provider.of<ProductByFieldProvider>(context, listen: false);
        productProvider.loadValues(ProductByField());
      });
    } else {
  ...
  Widget build(BuildContext context) {
    ...
    final productProvider = Provider.of<ProductByFieldProvider>(context);
    //final photoProvider = Provider.of<ProductByFieldPhotoProvider>(context);
              ...
              onPressed: () async {
                if (productname.text == "" || _category == "" || _brand == "") {
                  ...
                  if (widget.product != null) {
                    ...
                    productProvider.saveProductByField();
                  } else {
                    productProvider.changeDateAdded(now.toString());
                    productProvider.changeBinder(binderId);
                    productProvider.saveProductByField();
