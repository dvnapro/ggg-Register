...
class ProductByBrandList extends StatefulWidget {
  @override
  _ProductByBrandListState createState() => _ProductByBrandListState();
}

class _ProductByBrandListState extends State<ProductByBrandList> {
  ...
  Widget build(BuildContext context) {
    ...
    // for (int i = 0; i < len; i++) {
    //   if (bargs.brandId != products[i].brandId) {
    //     setState(() {
    //       len = 1;
    //     });
    //   }
      ...
      child: (products != null)
          ...
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return (bargs.brandId != products[index].brandId)
                    // ? Container(
                    //     height: 600,
                    //     child: Center(
                    //       child: Text(
                    //         "No Products currently available for " +
                    //             bargs.brandId.toString().toLowerCase(),
                    //         style: TextStyle(
