...
class ByCategoryList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final products = Provider.of<List<ProductByCategory>>(context);
    int len;
    len = products.length;
    print(len.toString() + " product " + products[0].name.toString());
      ...
      child: (products != null)
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                // Map newList = jsonDecode(products[index].toString());
                // var list = Product.fromFirestore();
