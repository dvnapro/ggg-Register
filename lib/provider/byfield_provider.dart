...
class ProductByFieldProvider with ChangeNotifier {
  ...
  loadValues(ProductByField product) {
  ...
  saveProductByField() {
    print(_productId);
    if (_productId == null) {
      var newProductByField = ProductByField(
          name: name,
          desc: desc,
          slug: slug,
          dateAdded: dateAdded,
          ...
          binderId: binderId,
          productId: uuid.v4());
      firestoreService.saveProductByField(newProductByField);
    } else {
      var updateProductByField = ProductByField(
          name: name,
          slug: slug,
          desc: desc,
          dateAdded: dateAdded,
          ...
          stockQRcode: stockQRcode,
          productId: productId);
      firestoreService.saveProductByField(updateProductByField);
    }
  }

  removeProductByField(String productId) {
    firestoreService.removeProductByField(productId);
  }
}
